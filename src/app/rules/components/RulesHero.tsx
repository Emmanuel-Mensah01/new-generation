      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl animate-fade-up">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold leading-tight mb-5 text-school-green">
            ...
            <span className="text-school-pink">{lang === 'sw' ? 'Taratibu' : 'Regulations'}</span>
          </h1>
          ...
          <div className="mt-6 flex items-center gap-4 text-sm text-gray-500">
            <span className="flex items-center gap-1.5 text-school-green font-semibold"><ShieldCheckIcon className="w-4 h-4" />{rulesCount} {lang === 'sw' ? 'Kanuni' : 'Rules'}</span>
